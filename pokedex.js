...
var pokedex = {}; //struckture {1 : {"name" : "bulbasaur", "img" : url, "type" : ["grass", "poison"], "description": "...."}}
...
function updatePokemon() {
    ...
    let types = pokedex[this.id]["types"];
        ...
        type.classList.add(types[i]["type"]["name"]); //adds background color and aswell font color
